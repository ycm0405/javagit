...
<form id="form1" name="form1" action="<%=ctx %>/news.do?method=add" method="post">
		<table width="90%" border="0" align="center" cellpadding="0" class="table2" cellspacing="0">
          ...
          <td>
		    ...
		    <tr>
		        ...
		        <td>
		        	<textarea id="content_1" name="content" style="width:605px;height:300px;visibility:hidden;"></textarea>
		        </td>
		    </tr>
		</table>
